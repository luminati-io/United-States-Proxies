...
- [**New York proxies**](https://brightdata.com/locations/united-states/new-york)
- [**Maryland proxies**](https://brightdata.com/locations/united-states/maryland)
- [**Texas proxies**](https://brightdata.com/locations/united-states/texas)
- [**Nevada proxies**](https://brightdata.com/locations/united-states/nevada)
...
A US proxy server is a server based in the United States that serves as an intermediary between your device and the internet. It provides anonymity, helps bypass restrictions and blocks, enables web content scraping, and enforces content filtering policies.

### Can I target ZIP codes across the US?
Yes, you can choose IPs using US zip code level targeting. Bright Data also offers city and state level US proxy targeting.
